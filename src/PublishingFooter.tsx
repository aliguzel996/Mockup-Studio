...
const copies: Record<PublishingLanguage, PublishingCopy> = {
  en: {
    ...
    privacyTitle: 'Privacy Policy', effective: 'Effective: 24 September 2026',
    sections: [
      ...
      { title: 'Files and device access', paragraphs: ['The app can open image files you select and save exported mockups. Android requests network access for website previews and uses the system file picker and download storage for files you explicitly open or export. Camera permission is requested only after you activate a camera feature inside an HTTPS website preview; camera access is then handled by that selected website under its own policy. The app does not request microphone, location or contacts access. Pen input is handled as a pointer and does not require a separate permission.'] },
  ...
  tr: {
    ...
    privacyTitle: 'Gizlilik Politikası', effective: 'Yürürlük: 24 Eylül 2026',
    sections: [
      ...
      { title: 'Dosya ve cihaz erişimi', paragraphs: ['Uygulama sizin seçtiğiniz görsel dosyalarını açabilir ve dışa aktarılan mockup’ları kaydedebilir. Android sürümü site önizlemeleri için ağ erişimi, açıkça seçtiğiniz veya dışa aktardığınız dosyalar için sistem dosya seçicisi ve indirme alanını kullanır. Kamera izni yalnızca HTTPS site önizlemesindeki bir kamera özelliğini siz çalıştırdığınızda istenir; kamera erişimi seçtiğiniz sitenin kendi politikası kapsamında gerçekleşir. Uygulama mikrofon, konum veya kişiler izni istemez. Kalem girişi pointer olarak işlenir ve ayrı izin gerektirmez.'] },
  ...
  de: {
    ...
    privacyTitle: 'Datenschutzerklärung', effective: 'Gültig ab: 24. September 2026',
    sections: [
      ...
      { title: 'Dateien und Berechtigungen', paragraphs: ['Die App öffnet von Ihnen gewählte Bilder und speichert Exporte. Android verwendet Internetzugriff, System-Dateiauswahl und Download-Speicher. Die Kameraberechtigung wird nur angefordert, wenn Sie eine Kamerafunktion in einer HTTPS-Vorschau aktivieren; der Zugriff unterliegt den Richtlinien der gewählten Website. Mikrofon, Standort und Kontakte werden nicht angefordert.'] },
  ...
  ja: {
    ...
    privacyTitle: 'プライバシーポリシー', effective: '施行日: 2026年9月24日',
    sections: [
      ...
      { title: 'ファイルと権限', paragraphs: ['選択した画像を開き、書き出しを保存できます。カメラ権限は、HTTPSサイトのプレビュー内でカメラ機能を操作した場合にのみ要求され、選択したサイトのポリシーが適用されます。マイク、位置情報、連絡先の権限は要求しません。'] },
  ...
  'es-419': {
    ...
    privacyTitle: 'Política de privacidad', effective: 'Vigente desde: 24 de septiembre de 2026',
    sections: [
      ...
      { title: 'Archivos y permisos', paragraphs: ['La app abre imágenes elegidas y guarda exportaciones. El permiso de cámara se solicita solo cuando activas una función de cámara dentro de una vista previa HTTPS; el acceso queda sujeto a la política del sitio elegido. No solicita micrófono, ubicación ni contactos.'] },
  ...
  'pt-BR': {
    ...
    privacyTitle: 'Política de Privacidade', effective: 'Vigência: 24 de setembro de 2026',
    sections: [
      ...
      { title: 'Arquivos e permissões', paragraphs: ['O app abre imagens selecionadas e salva exportações. A permissão de câmera só é solicitada quando você ativa uma função de câmera em uma prévia HTTPS; o acesso segue a política do site escolhido. Não solicita microfone, localização ou contatos.'] },
  ...
  ko: {
    ...
    privacyTitle: '개인정보 처리방침', effective: '시행일: 2026년 9월 24일',
    sections: [
      ...
      { title: '파일 및 권한', paragraphs: ['선택한 이미지를 열고 내보내기를 저장합니다. 카메라 권한은 HTTPS 사이트 미리보기에서 사용자가 카메라 기능을 실행할 때만 요청되며, 선택한 사이트의 정책이 적용됩니다. 마이크, 위치 또는 연락처 권한은 요청하지 않습니다.'] },
  ...
  fr: {
    ...
    privacyTitle: 'Politique de confidentialité', effective: 'En vigueur : 24 septembre 2026',
    sections: [
      ...
      { title: 'Fichiers et autorisations', paragraphs: ['L’application ouvre les images choisies et enregistre les exports. L’autorisation de caméra est demandée uniquement lorsque vous activez une fonction caméra dans un aperçu HTTPS ; l’accès relève alors de la politique du site choisi. Le microphone, la localisation et les contacts ne sont pas demandés.'] },
