...
Hazır paket: `Responsive-Mockup-Studio-Web-cPanel-1.3.1.zip`
...
9. `https://ycswu.co/mockup-studio/` adresini gizli sekmede aç. Eski cache görünürse sürüme özel `https://ycswu.co/mockup-studio/index-1.3.1.html` adresini bir kez aç.
